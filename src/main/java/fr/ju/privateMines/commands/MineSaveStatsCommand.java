...
public class MineSaveStatsCommand implements SubCommand {
    private final MineManager mineManager;
    private final ConfigManager configManager;
    private final PrivateMines plugin;

    public MineSaveStatsCommand(MineManager mineManager, ConfigManager configManager, PrivateMines plugin) {
